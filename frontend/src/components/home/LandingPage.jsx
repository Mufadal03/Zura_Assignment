  ...
  return (
    <div>
      <div className="max-w-screen-xl mx-auto">
        <h1 className="text-purple text-[3rem] font-bold text-center">
          {" "}
      ...
      <div className="flex justify-center mt-1">
        <button
          ...
          className=" flex items-center gap-3 justify-center bg-activeBlack text-white text-[2rem] p-3 w-[25%] rounded-lg"
        >
